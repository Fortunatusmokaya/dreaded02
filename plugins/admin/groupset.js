exports.run = {
   ...
   async: async (m, {
      ...
      if (command == 'setname') {
         if (!value) return client.reply(m.chat, Func.example(isPrefix, command, 'DREADED BOT'), m)
         if (value > 25) return client.reply(m.chat, Func.texted('bold', `text is too long, maximum 25 character. 🗿 -_-`), m)
