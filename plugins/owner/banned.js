exports.run = {
   ...
   async: async (m, {
      ...
      try {
         ...
         if (command == 'ban') {
            if (is_owner) return client.reply(m.chat, Func.texted('bold', `❌ Can't ban owner number. 🌚`), m)
            ...
            client.reply(m.chat, ` ⚠️ *B A N N E D*\n\n*“Successfully added @${user.split`@`[0]} into the banned list.”*\n\n*Total : ${banned}*`, m)
